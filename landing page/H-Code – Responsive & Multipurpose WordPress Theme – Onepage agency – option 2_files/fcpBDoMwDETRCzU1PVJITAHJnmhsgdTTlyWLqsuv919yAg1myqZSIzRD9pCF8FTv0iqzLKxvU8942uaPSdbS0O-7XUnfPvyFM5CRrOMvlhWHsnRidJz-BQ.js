...
Carousel.DEFAULTS={interval:15000,pause:'hover',wrap:true}
...
Collapse.prototype.toggle=function(){var isTouchDevice="ontouchstart"in window||navigator.msMaxTouchPoints;if(isTouchDevice)
this[this.$element.hasClass('in')?'hide':'show']()
else{if(this.$element.parent().parent().hasClass("navbar-nav")){if($('.navbar-toggle').is(":visible")){this[this.$element.hasClass('in')?'hide':'show']()}}
...
$.support.transition&&this.$element.hasClass('fade')?this.$element.one('bsTransitionEnd',$.proxy(this.hiDemosdal,this)).emulateTransitionEnd(300):this.hiDemosdal()}
Modal.prototype.enforceFocus=function(){$(document).off('focusin.bs.modal').on('focusin.bs.modal',$.proxy(function(e){if(this.$element[0]!==e.target&&!this.$element.has(e.target).length){this.$element.trigger('focus')}},this))}
Modal.prototype.escape=function(){if(this.isShown&&this.options.keyboard){this.$element.on('keyup.dismiss.bs.modal',$.proxy(function(e){e.which==27&&this.hide()},this))}else if(!this.isShown){this.$element.off('keyup.dismiss.bs.modal')}}
Modal.prototype.hiDemosdal=function(){var that=this
this.$element.hide()
...
Plugin.call($spy,data)})})}(jQuery);;"use strict";var isTouchDevice="ontouchstart"in window||navigator.msMaxTouchPoints;if(!isTouchDevice){;(function($,window,undefined){var $allDropdowns=$();$.fn.dropdownHover=function(options){if('ontouchstart'in document)return this;$allDropdowns=$allDropdowns.add(this.parent());var hcodeDelay=($('nav').attr('data-menu-hover-delay'))?$('nav').attr('data-menu-hover-delay'):"100";return this.each(function(){var $this=$(this),$parent=$this.parent(),defaults={delay:hcodeDelay,instantlyCloseOthers:true},data={delay:$(this).data('delay'),instantlyCloseOthers:$(this).data('close-others')},showEvent='show.bs.dropdown',hideEvent='hide.bs.dropdown',settings=$.extend(true,{},defaults,options,data),timeout;$parent.hover(function(event){openDropdown(event);},function(){timeout=window.setTimeout(function(){$parent.removeClass('open');$this.trigger(hideEvent);},settings.delay);});$this.hover(function(event){if(!$parent.hasClass('open')&&!$parent.is(event.target)){return true;}
